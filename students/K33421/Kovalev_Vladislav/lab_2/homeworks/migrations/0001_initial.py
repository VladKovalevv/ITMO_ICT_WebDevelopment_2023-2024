    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('homework_submission', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='homeworks.homeworksubmission')),
            ],
        ),
        migrations.AddField(
            model_name='homework',
            name='subject',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='homeworks.subject'),
        ),
        migrations.AddField(
            model_name='homework',
            name='teacher',
